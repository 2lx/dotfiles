...
hi Conceal          cterm=none ctermbg=1    ctermfg=13
...
hi DiffAdd          cterm=bold ctermbg=2    ctermfg=13
hi DiffChange       cterm=bold ctermbg=4    ctermfg=13
hi DiffDelete       cterm=bold ctermbg=1    ctermfg=13
hi DiffText         cterm=bold ctermbg=3    ctermfg=8
" error messages on the command line
hi ErrorMsg         cterm=none ctermbg=1    ctermfg=13
...
hi IncSearch        cterm=none ctermbg=9    ctermfg=8
" line number for :number and :# commands
hi LineNr           cterm=none ctermbg=7    ctermfg=5
" like LineNr when 'cursorline' is set for the cursor line
hi CursorLineNr     cterm=bold ctermbg=7    ctermfg=5
" character under the cursor if it's a paired bracket
hi MatchParen       cterm=none ctermbg=6    ctermfg=13
...
" normal text
hi Normal           cterm=none ctermbg=none ctermfg=8
" popup meny: normal item, selected item, scrollbar, thumb of SB
hi Pmenu            cterm=none ctermbg=8    ctermfg=13
...
hi Question         cterm=none ctermbg=none ctermfg=13
...
" any variable name
hi Identifier       cterm=none ctermbg=none ctermfg=13
" function name
...
hi Include          cterm=none ctermbg=none ctermfg=3
...
hi Underlined  cterm=underline ctermbg=none ctermfg=6
...
hi Todo             cterm=none ctermbg=7    ctermfg=9
